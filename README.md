...
`[pipeline_version]` is a release version of the pipeline. For example this repository has currently been released for version `1.0.1`. So we need to input `1.0.1` in place of `[pipeline_version]`.
